...
Technically, \isa{SI} is a tag-type that represents the fact that the magnitude in a quantity is
actually a quantifiable entity in the sense of the SI system, i.e., that the \isa{1[L]} actually 
...
The theory of the SI is created for the instance of the \isa{Measurement\_System} with SI.
...
integer numbers (\isa{int}), integer numbers representable by 32 bits (\isa{int32}), or, for example,
