...
[si_eq]: "foot = 1/3 \<odot> yard"

lemma foot_alt_def: "foot = 0.3048 \<odot> metre"
  by (si_simp)

definition inch :: "'a[L]" where
[si_eq]: "inch = (1 / 36) \<odot> yard"

lemma inch_alt_def: "inch = 25.4 \<odot> milli \<odot> metre"
  by (si_simp)

definition mile :: "'a[L]" where
[si_eq]: "mile = 1760 \<odot> yard"

lemma mile_alt_def: "mile = 1609.344 \<odot> metre"
  by (si_simp)
